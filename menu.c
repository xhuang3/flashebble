...
void draw_row_callback(GContext *ctx, Layer *cell_layer, MenuIndex *cell_index, void *callback_context)
{
    ...
    {
    case 0:
        menu_cell_basic_draw(ctx, cell_layer, "1. SAT", "1000 Vocabs", NULL);
        break;
    case 1:
        menu_cell_basic_draw(ctx, cell_layer, "2. GRE", "2000 Vocabs", NULL);
        break;
    case 2:
        menu_cell_basic_draw(ctx, cell_layer, "3. GMAT", "3000 Vocabs", NULL);
        break;
    }
}
